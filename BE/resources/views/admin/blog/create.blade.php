                        ...
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-2">
                            ...
                            <div class="d-flex bd-highlight" style="height: 40px;">
                                <div class="bd-highlight">
                                    <h6 class="text-white text-capitalize ps-3 p-2 ">Add Blog</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <form action="" class="w3-container ">
                                ...
                                name="title" placeholder="Nhập tiêu đề..." type="text" value="{{ old('title') }}">
                                    @error('title')
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="/" class="font-weight-bold" target="_blank">NeoLock</a>
                            for a better web.
                        </div>
                    </div>
                    <div class="col-lg-6">
